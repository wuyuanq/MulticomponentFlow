...
program infile_RSTi_singlePhaseFlow
    ...
    modelCase%pBdryX(2,1:times) = initPres(1:times) !!!!!!
    allocate(modelCase%pBdryY(modelCase%nx,2))
    modelCase%pBdryY(:,:) = 0.0
    modelCase%pBdryY(modelCase%nx-times+1:modelCase%nx,1) = initPres(1) !!!!!!!!
