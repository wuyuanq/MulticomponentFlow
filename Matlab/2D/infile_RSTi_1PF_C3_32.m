...
% corner (production point) and up-left corner (injection point) are open
...
model.xBdryX(1, 1, model.ny) = 1.0;
model.xBdryY(1, 1, 2) = 1.0;
...
model.uBdryX(1,end) = -uconst;
model.uBdryY(1,2) = -uconst;
