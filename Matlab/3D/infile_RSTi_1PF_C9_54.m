...
% point is at the front-left-up corner and the production point is at the back-right-down
...
model.isDiriX(2, 1, end) = 1; 
model.isDiriY(end, 1, end) = 1; 
model.isDiriZ(end, 1, 2) = 1; 
...
model.pBdryX(2, 1, end) = initPres(1);
model.pBdryY(end, 1, end) = initPres(1);
model.pBdryZ(end, 1, 2) = initPres(1);
