...
% point is at the front-left-up corner and the production point is at the front-right-up
...
model.isDiriX(2, end, 1) = 1; 
model.isDiriY(end, 2, 1) = 1; 
model.isDiriZ(end, end, 1) = 1; 
...
model.pBdryX(2, end, 1) = initPres(end);
model.pBdryY(end, 2, 1) = initPres(end);
model.pBdryZ(end, end, 1) = initPres(end);
