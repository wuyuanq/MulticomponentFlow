...
% point is at the front-left-up corner and the production point is at the front-left-down
...
model.isDiriX(1, 1, 1) = 1; 
model.isDiriY(1, 1, 1) = 1; 
model.isDiriZ(1, 1, 1) = 1; 
...
model.pBdryX(1, 1, 1) = initPres(1);
model.pBdryY(1, 1, 1) = initPres(1);
model.pBdryZ(1, 1, 1) = initPres(1);
