...
% point is at the front-left-up corner and the production point is at the front-right-down
...
model.isDiriX(2, 1, 1) = 1; 
model.isDiriY(end, 1, 1) = 1; 
model.isDiriZ(end, 1, 1) = 1;  
...
model.pBdryX(2, 1, 1) = initPres(1);
model.pBdryY(end, 1, 1) = initPres(1);
model.pBdryZ(end, 1, 1) = initPres(1);
