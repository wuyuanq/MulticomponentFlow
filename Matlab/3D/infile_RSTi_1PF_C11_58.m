...
% point is at the front-left-up corner and the production point is at the back-right-up
...
model.isDiriX(2, end, end) = 1; 
model.isDiriY(end, 2, end) = 1; 
model.isDiriZ(end, end, 2) = 1;
...
model.xBdryX(1, 1, end, 1) = 1.0;
model.xBdryY(1, 1, 2, 1) = 1.0;
model.xBdryZ(1, 1, end, 1) = 1.0;
...
model.xBdryX(2, 1, end, 1) = 0.0;
model.xBdryY(2, 1, 2, 1) = 0.0;
model.xBdryZ(2, 1, end, 1) = 0.0;
...
model.uBdryX(1, end, 1) = -uconst;
model.uBdryY(1, 2, 1) = -uconst;
model.uBdryZ(1, end, 1) = -uconst;
...
model.pBdryX(2, end, end) = initPres(end);
model.pBdryY(end, 2, end) = initPres(end);
model.pBdryZ(end, end, 2) = initPres(end);
