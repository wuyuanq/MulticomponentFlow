...
program infile_RSTi_singlePhaseFlow
    ...
    modelCase%Lx = 4.0
    modelCase%Ly = 4.0
    modelCase%timeEnd = 2.0*365*24*3600.0
    modelCase%nx = 40
    modelCase%ny = 40
    modelCase%nt = 2.0*365*24
